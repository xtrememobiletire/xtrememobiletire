...
const MemberDashboard = () => {
  ...
  const closePayModal = () => { setPayingInvoice(null); setClientSecret(''); setPayStep('info'); setPayError(''); };
            ...
            <div className="px-6 py-6">
              {payStep === 'info' && (
                <div>
                  ...
                  <p className="text-sm text-gray-400 mb-5">
                    💳 You can pay through <strong className="text-white">bank transfer</strong> or securely via Stripe below.
                  </p>
              ...
              {payStep === 'success' && (
                <div className="text-center py-6">
                  ...
                  <p className="text-gray-400 text-sm mb-6">Invoice {payingInvoice.invoiceNumber} has been paid. Check Completed Invoices.</p>
